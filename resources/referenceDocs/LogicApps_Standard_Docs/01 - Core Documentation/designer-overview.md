<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/designer-overview -->
...
- A Standard logic app resource in single-tenant Azure Logic Apps. This logic app can have either no workflows or existing workflows.
  ...
  For more information, see [Create a Standard logic app workflow with the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal).
...
1. To open the preview designer, in the banner, select **Enable preview**.
   ...
   ![A screenshot of the Workflows options in the working pane of the Azure portal with the Enable preview button emphasized. ](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/designer-overview/enable-preview.png)
...
1. On the **Workflows** page toolbar, select **+ Create**.
   ...
   ![Screenshot shows workflow types available in preview experience.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/designer-overview/create-workflow.png)   
...
The designer provides a visual way to add, edit, and delete steps in your workflow. As the first step, always start by adding a [*trigger*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#logic-app-concepts) to start your workflow. You can then continue building the workflow by adding one or multiple [*actions*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#logic-app-concepts) that run after the trigger fires.

To add a trigger or an action to your Standard workflow, see [Build a workflow with a trigger or action in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action). Then, configure your trigger or action as needed.
...
![Screenshot shows the preview designer and the view selector at the top.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/designer-overview/view-selector.png)
...
| **Parameters** | Create workflow parameters across environments. See [Create cross-environment parameters for workflow inputs](https://learn.microsoft.com/en-us/azure/logic-apps/create-parameters-workflows). |
| **Connections** | View connections in your workflow. |
| **Errors** | View workflow validation errors. |
| **AI** > **Assistant** | Open the workflow assistant. See [Get AI-powered help about Standard workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/workflow-assistant-standard). |
...
![Screenshot shows the preview designer and toolbar with vertical ellipsis menu next to the Publish button.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/designer-overview/ellipsis.png)
...
- [Create Standard workflows in single-tenant Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal)
