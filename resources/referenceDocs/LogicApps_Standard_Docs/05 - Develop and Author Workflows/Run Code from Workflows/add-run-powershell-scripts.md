<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/add-run-powershell-scripts -->
...
- Integrate with [Azure Functions PowerShell functions](https://learn.microsoft.com/en-us/azure/azure-functions/functions-reference-powershell), which provides powerful functionality and inheritance for advanced task execution.
...
- Make sure that your logic app uses the latest runtime version for Azure Functions runtime in Azure, which is version 4.x. For more information, see [View the current runtime version](https://learn.microsoft.com/en-us/azure/azure-functions/set-runtime-version.md?tabs=azure-portal#view-the-current-runtime-version).
...
> about available versions, see the [Azure Functions PowerShell developer guide](https://learn.microsoft.com/en-us/azure/azure-functions/functions-reference-powershell.md#powershell-versions).
...
1. After the action information pane opens, on the **Parameters** tab, in the **Code File** box, update the prepopulated sample code with your own code.
   ...
   ![Screenshot shows Azure portal, Standard workflow designer, Request trigger, Execute PowerShell Code action with information pane open, and Response action. Information pane shows sample PowerShell script.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-run-powershell-scripts/action-sample-script.png)
...
The **Execute PowerShell Code** action includes following custom [PowerShell commands (cmdlets)](https://learn.microsoft.com/en-us/powershell/scripting/powershell-commands) for interacting with your workflow and other operations in your workflow:
...
> For more information, see [Microsoft.PowerShell.Utility](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.utility).
...
You can generate your own private PowerShell modules. To create your first PowerShell module, see [Write a PowerShell Script Module](https://learn.microsoft.com/en-us/powershell/scripting/developer/module/how-to-write-a-powershell-script-module).
...
- [Add and run JavaScript code snippets](https://learn.microsoft.com/en-us/azure/logic-apps/add-run-javascript)
