<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-run-custom-code-functions -->
...
For more information about limitations in Azure Logic Apps, see [Limits and configuration - Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config).

## Prerequisites

- An Azure account and subscription. If you don't have a subscription, [sign up for a free Azure account](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).

- The most recent Visual Studio Code with the Azure Logic Apps (Standard) extension. To meet these requirements, see the prerequisites for [Create Standard workflows in single-tenant Azure Logic Apps with Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code#prerequisites).
...
1. In the **Azure** window that opens, on the **Workspace** section toolbar, from the **Azure Logic Apps** menu, select **Create new logic app workspace**. 
   ...
   ![Screenshot shows Visual Studio Code, Azure window, Workspace section toolbar, and selected option for Create new logic app workspace.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/create-workspace.png)
...
1. When the **Create new logic app workspace** prompt box appears, provide a name for your workspace:
   ...
   ![Screenshot shows Visual Studio Code with prompt to enter workspace name.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/workspace-name.png)
...
1. When the **Select a project template for your logic app workspace** prompt box appears, select **Logic app with custom code project**.
   ...
   ![Screenshot shows Visual Studio Code with prompt to select project template for logic app workspace.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/project-template.png)
...
1. Select **Open in current window**.
   ...
   ![Screenshot shows Visual Studio Code with created workspace.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/created-workspace.png)
...
1. In the **Explorer** window, open the shortcut menu for the functions project folder, and select **Build functions project**.
   ...
   ![Screenshot shows Visual Studio Code, Explorer window, and functions project shortcut menu with selected option for Build functions project.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/build-functions-project.png)
...
1. Confirm that the following items exist in your logic app project:
   ...
   ![Screenshot shows Visual Studio Code and logic app workspace with .NET functions project and logic app project, now with the generated assemblies and other required files.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/generated-assemblies.png)
...
1. Select the action named **Call a local function in this logic app**.
   ...
   ![Screenshot shows Visual Studio Code, workflow designer, and default workflow with trigger and actions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/default-workflow.png)
...
1. For each of the following Azure Storage services, start the Azurite storage emulator:
   ...
   ![Screenshot shows Visual Studio Code taskbar with Azure Blob Service, Azure Queue Service, and Azure Table Service running.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/storage-services-running.png)
...
1. Attach the debugger to both your logic app project and .NET functions project by following these steps:
   ...
   1. On the Visual Studio Code Activity Bar, select **Run and Debug**. (Keyboard: Ctrl+Shift+D)
      ...
      ![Screenshot shows Visual Studio Code Activity Bar with Run and Debug selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/run-debug.png)
   ...
   1. From the **Run and Debug** list, select **Run/debug logic app with local function (LogicApp)**, if not already selected, and then select **Play** (green arrow).
      ...
      ![Screenshot shows Run and Debug list with selection option for Run/debug logic app with local function.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/attach-debugger-logic-app-with-local-function.png)
...
1. To set any breakpoints, in your function definition (**<*function-name*>.cs**) or workflow definition (**workflow.json**), find the line number where you want the breakpoint, and select the column to the left, for example:
   ...
   ![Screenshot shows Visual Studio Code and the open function code file with a breakpoint set for a line in code.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/set-breakpoint.png)
...
1. To manually run the Request trigger in your workflow, open the workflow's **Overview** page.
   ...
   1. From your logic app project, open the **workflow.json** file's shortcut menu, and select **Overview**.
      ...
      ![Screenshot shows Visual Studio Code and workflow's Overview page opened.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/workflow-overview.png)
...
1. To review more information about the workflow run, select the finished run. Or, from the list next to the **Duration** column, select **Show run**.
   ...
   ![Screenshot shows Visual Studio Code and finished workflow run.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-run-custom-code-functions/workflow-run-history.png)
...
For more information, see [Deploy Standard workflows from Visual Studio Code to Azure](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code#deploy-azure).
...
[Create Standard workflows with Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code)
