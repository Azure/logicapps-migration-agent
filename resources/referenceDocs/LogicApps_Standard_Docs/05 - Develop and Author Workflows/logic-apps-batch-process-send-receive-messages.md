<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-batch-process-send-receive-messages -->
...
* An email account with any [email provider supported by Azure Logic Apps](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors)
...
* Basic knowledge about [logic app workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview)

* To use Visual Studio Code rather than the Azure portal, make sure that you [set up Visual Studio Code for working with Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-logic-apps-visual-studio-code).
...
1. In the workflow designer, select **Add a trigger**, and [follow these general steps to add the **Batch Operations** trigger named **Batch Trigger**](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-trigger).
...
1. Set the following trigger properties:
   ...
   ![Screenshot shows all criteria for Batch Trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-receiver-criteria.png)
...
1. Now add one or more actions that process each batch.
   ...
   1. [Follow these general steps to add an action that sends an email](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action), based on your email provider.
...
1. Set the following action properties:
   ...
   * Select inside the **Subject** box to view the options for the dynamic content list (lightning icon) and expression editor (function icon). Select the lightning icon to open the dynamic content list, and select the field named **Partition Name**.
     ...
     ![Screenshot shows dynamic content list and selected field for Partition Name property.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/send-email-action-details.png)
   ...
   * Select inside the **Body** box, select the lightning icon to open the dynamic content list, and select the **Message Message Id** field.
     ...
     ![Screenshot shows Batched Items collection with previous operation outputs.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/send-email-action-details-for-each.png)
...
1. Save your workflow. You've now created a batch receiver.
   ...
   > [*deploy* your batch receiver logic app resource to Azure](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-logic-apps-visual-studio-code). 
...
1. [Follow these general steps to add the **Schedule** trigger named **Recurrence**](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-trigger).
...
1. Add a new action for sending messages to a batch.
   ...
   1. [Follow these general steps to add a **Batch Operations** action named **Send to batch trigger workflow** (Consumption workflow) or **Send to batch** (Standard workflow)](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action).
   ...
   1. Based on whether you have a Consumption workflow or Standard workflow, follow the corresponding steps:
      ...
      **Consumption workflow**
      ...
      1. From the logic apps list, select the previously created logic app to use as the batch receiver. When the available triggers appear, select the trigger named **Batch_messages**.
         ...
         ![Screenshot shows Consumption workflow with Recurrence trigger and batch sender action that selects a batch receiver logic app resource and trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-select-batch-receiver-consumption.png)
         ...
         > [how to deploy your batch receiver logic app resource to Azure](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-logic-apps-visual-studio-code).
      ...
      **Standard workflow**
      ...
      ![Screenshot shows Standard workflow with Recurrence trigger and action named Send to batch.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-standard.png)
...
1. Set the following batch receiver action properties:
   ...
   1. In the editor, enter the function named **utcnow()**, and select **Add**.
      ...
      **Consumption workflow**
      ...
      ![Screenshot shows Consumption workflow, batch sender action pane, Message Content box with cursor, expression editor with utcNow function, and other details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-details-consumption.png)

      **Standard workflow**

      ![Screenshot shows Standard workflow, batch sender action pane, Message Content box with cursor, expression editor with utcNow function, and other details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-details-standard.png)
...
1. Now set up a partition for the batch.
   ...
   1. In the expression editor, enter the function **rand(1,6)**, and select **Add**.
      ...
      ![Screenshot shows function named rand for dividing batch into partitions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-partition.png)
      ...
      **Consumption workflow**
      ...
      ![Screenshot shows finished batch sender Consumption logic app workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-finished-consumption.png)

      **Standard workflow**

      ![Screenshot shows finished batch sender Standard logic app workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-batch-process-send-receive-messages/batch-sender-finished-standard.png)
