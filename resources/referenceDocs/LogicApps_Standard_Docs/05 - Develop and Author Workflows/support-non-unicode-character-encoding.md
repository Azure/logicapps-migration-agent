<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/support-non-unicode-character-encoding -->
...
If you set the `Content-Type` header to `application/octet-stream`, you also might receive characters that aren't UTF-8. For more information, see [how to handle the `application/octet-stream` content type](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-content-type#applicationxml-and-applicationoctet-stream).

## Base64 encode content

Before you [base64 encode](https://learn.microsoft.com/en-us/azure/logic-apps/expression-functions-reference#base64) content to a string, make sure that you [convert the text to UTF-8](#convert-payload-encoding). Otherwise, characters might return corrupted.
...
When you consume the return value from Azure Functions, make sure to use the [**base64ToBinary** function](https://learn.microsoft.com/en-us/azure/logic-apps/expression-functions-reference#base64tobinary), not the **base64ToString** function.
...
> [Encode and decode flat files in Azure Logic Apps by using the Enterprise Integration Pack](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-flatfile)
