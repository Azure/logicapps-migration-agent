<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow -->
...
- A logic app resource and workflow, based on whether you want to add a trigger or an action:
  ...
  - [Create an example Consumption logic app workflow in the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-example-consumption-workflow)

  - [Create an example Standard logic app workflow in the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal)
  ...
  - [Create Consumption logic app workflows in Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-logic-apps-visual-studio-code)

  - [Create Standard logic app workflows in Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code)
...
1. On the designer, select **Add a trigger**, if not already selected.
   ...
   ![Screenshot shows Azure portal, Consumption workflow designer, and pane named Add a trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/designer-overview-triggers-consumption.png)
...
1. Choose either option:
   ...
   ![Screenshot shows Consumption blank workflow designer and pane named Add a trigger. In the By Connector section, the Built-in option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-triggers-consumption.png)
   ...
   ![Screenshot shows Consumption blank workflow designer and pane named Add a trigger. In the By Connector section, the Shared option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-triggers-consumption.png)
...
1. On the designer, select **Add a trigger**, if not already selected.
   ...
   ![Screenshot shows Azure portal, Standard workflow designer, and pane named Add a trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/designer-overview-triggers-standard.png)
...
1. Choose either option:
   ...
   ![Screenshot shows Standard blank workflow designer and pane named Add a trigger. In the By Connector section, the Built-in option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-triggers-standard.png)
   ...
   ![Screenshot shows Standard blank workflow designer and pane named Add a trigger. In the By Connector section, the Shared option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-triggers-standard.png)
...
1. On the designer, choose either option:
   ...
   * To add the action between existing steps, select the plus sign (**+**) on the connecting arrow, and then select **Add an action**.
   ...
   ![Screenshot shows Azure portal, Consumption workflow designer, and pane named Add an action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/designer-overview-actions-consumption.png)
...
1. Choose either option:
   ...
   ![Screenshot shows Consumption workflow designer and pane named Add an action. In the By Connector section, the Built-in option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-actions-consumption.png)
   ...
   ![Screenshot shows Consumption workflow designer and pane named Add an action. In the By Connector section, the Shared option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-actions-consumption.png)
...
1. On the designer, choose either option:
   ...
   * To add the action between existing steps, select the plus sign (**+**) on the connecting arrow, and then select **Add an action**.
   ...
   ![Screenshot shows Standard workflow designer and pane named Add an action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/designer-overview-actions-standard.png)
...
1. Choose either option:
   ...
   ![Screenshot shows Standard workflow designer and pane named Add an action. In the By Connector section, the Built-in option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-actions-standard.png)
   ...
   ![Screenshot shows Standard workflow designer and pane named Add an action. In the By Connector section, the Shared option is selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-actions-standard.png)
...
In the workflow designer, you can select from [1,400+ connector triggers and actions](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors), collectively called *operations*. Azure Logic Apps organizes operations into either collections such as **Schedule** and **Data Operations**, or as connectors such as **Azure Blob Storage** and **SQL Server**. Collections and connectors can include triggers, actions, or both.
...
![Screenshot shows Standard workflow designer and Built-in operation collections and connectors.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-triggers-standard.png)
...
![Screenshot shows Standard workflow designer and Schedule operation collection with Recurrence trigger and Sliding Window trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-selected-triggers.png)

The following example shows the **Built-in** collections and connectors when you add an action:

![Screenshot shows Standard workflow designer, pane named Add an action, and selected Built-in option.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-actions-standard.png)

The following example shows the selected **Azure Queue Storage** connector and its actions:

![Screenshot shows Standard workflow designer, pane named Add an action, and Azure Queue Storage connector with actions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/built-in-selected-actions.png)
...
![Screenshot shows Standard workflow designer and Shared connectors with triggers.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-triggers-standard.png)

After you select a collection or connector, triggers appear based on the collection or connector name.

The following example shows the selected **365 Training** connector and its triggers:

![Screenshot shows Standard workflow designer, and 365 Training connector with triggers.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-selected-triggers.png)

The following example shows the **Shared** connectors gallery when you add an action:

![Screenshot shows Standard workflow designer and Shared connectors with actions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-actions-standard.png)

The following example shows the selected **365 Training** connector and its actions:

![Screenshot shows Standard workflow designer and 365 Training connector with actions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/add-trigger-action-workflow/shared-selected-actions.png)

For more information, see the following documentation:

- [Built-in operations and connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/connectors/built-in)
- [Microsoft-managed connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors)
- [Custom connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/custom-connector-overview)
- [Billing and pricing for operations in Consumption workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-pricing#consumption-operations)
- [Billing and pricing for operations in Standard workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-pricing#standard-operations)

## Related content

[General information about connectors, triggers, and actions](https://learn.microsoft.com/en-us/connectors/connectors)
