<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-create-api-app -->
...
You can also host your APIs on [Azure App Service](https://learn.microsoft.com/en-us/azure/app-service/overview), 
...
[*actions*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#logic-app-concepts) 
that perform specific tasks in workflows. Your API can also act as a 
[*trigger*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#logic-app-concepts) 
...
> 
> * [ASP.NET](https://learn.microsoft.com/en-us/azure/app-service/quickstart-dotnetcore). 
> * [Java](https://learn.microsoft.com/en-us/azure/app-service/quickstart-java)
> * [Node.js](https://learn.microsoft.com/en-us/azure/app-service/quickstart-nodejs)
> * [PHP](https://learn.microsoft.com/en-us/azure/app-service/quickstart-php)
> * [Python](https://learn.microsoft.com/en-us/azure/app-service/quickstart-python)

## How do custom APIs differ from custom connectors?

Custom APIs and [custom connectors](https://learn.microsoft.com/en-us/azure/logic-apps/custom-connector-overview) 
...
* [Create custom connectors from Web APIs](https://learn.microsoft.com/en-us/connectors/custom-connectors/create-web-api-connector)
* [Register custom connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/connectors/custom-connectors/)
...
with an [HTTP action](https://learn.microsoft.com/en-us/azure/connectors/connectors-native-http) 
or an [HTTP + Swagger](https://learn.microsoft.com/en-us/azure/connectors/connectors-native-http-swagger) action. 
By default, responses must be returned within the [request timeout limit](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config). 

![Standard action pattern](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-create-api-app/standard-action.png)
...
[request timeout limit](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config), 
...
![Polling action pattern](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-create-api-app/custom-api-async-action-pattern.png)
...
![Webhook action pattern](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-create-api-app/custom-api-webhook-action-pattern.png)

Currently, the workflow designer doesn't support discovering webhook endpoints through Swagger. So for this pattern, you have to add a [**Webhook** action](https://learn.microsoft.com/en-us/azure/connectors/connectors-native-webhook) and specify the URL, headers, and body for your request. See also [Workflow actions and triggers](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers#apiconnection-webhook-action). For an example webhook pattern, review this [webhook trigger sample in GitHub](https://github.com/logicappsio/LogicAppTriggersExample/blob/master/LogicAppTriggers/Controllers/WebhookTriggerController.cs).
...
Your custom API can act as a [*trigger*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#logic-app-concepts) 
that starts a workflow run when new data or an event meets a specified condition. 
...
Also, learn more about [usage metering for triggers](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-pricing).
...
![Polling trigger pattern](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-create-api-app/custom-api-polling-trigger-pattern.png)
...
![Webhook trigger pattern](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-create-api-app/custom-api-webhook-trigger-pattern.png)

Currently, the workflow designer doesn't support discovering webhook endpoints through Swagger. So for this pattern, you have to add a [**Webhook** trigger](https://learn.microsoft.com/en-us/azure/connectors/connectors-native-webhook) and specify the URL, headers, and body for your request. See also [HTTPWebhook trigger](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers#httpwebhook-trigger). For an example webhook pattern, review this [webhook trigger controller sample in GitHub](https://github.com/logicappsio/LogicAppTriggersExample/blob/master/LogicAppTriggers/Controllers/WebhookTriggerController.cs).
...
After creating your custom APIs, set up authentication for your APIs so that you can call them securely from logic apps. Learn [how to improve security for calls to custom APIs from logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-custom-api-authentication).

## Deploy and call your APIs

After you set up authentication, set up deployment for your APIs. 
Learn [how to deploy and call custom APIs from logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-custom-api-host-deploy-call).
...
For more information, see [Custom connectors overview](https://learn.microsoft.com/en-us/azure/logic-apps/custom-connector-overview). 
...
* [Handle errors and exceptions](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-exception-handling)
* [Call, trigger, or nest logic apps with HTTP endpoints](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-http-endpoint)
* [Usage metering for actions and triggers](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-pricing)
