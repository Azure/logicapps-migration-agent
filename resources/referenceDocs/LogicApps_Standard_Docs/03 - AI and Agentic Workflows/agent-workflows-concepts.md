<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/agent-workflows-concepts -->
...
1. Based on whether you have a Consumption or Standard agentic workflow, the agent uses an Azure OpenAI model or LLM API from the following source to interpret and understand the instructions and request. The agent also uses the model to process and analyze the provided inputs.
   ...
   |-----------|--------------|
   | Consumption | [Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-models/concepts/models) |
   | Standard | - [Azure OpenAI Service resource](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models) <br>- [Microsoft Foundry project](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models) (preview) <br>- [Azure API Management account](https://learn.microsoft.com/en-us/azure/api-management/genai-gateway-capabilities) with an LLM API (preview) |
...
![Screenshot shows Azure portal, workflow designer, and example basic autonomous agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/weather-example-autonomous.png)
...
1. Based on whether you have a Consumption or Standard agentic workflow, the agent uses an Azure OpenAI model or LLM API from the following source to interpret and understand the instructions and request. The agent also uses the model to process and analyze the provided inputs.
   ...
   |-----------|--------------|
   | Consumption | [Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-models/concepts/models) |
   | Standard | - [Azure OpenAI Service resource](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models) <br>- [Azure API Management account](https://learn.microsoft.com/en-us/azure/api-management/genai-gateway-capabilities) with an LLM API (preview) |
...
![Screenshot shows Azure portal, workflow designer, and example basic conversational agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/weather-example-conversational.png)
...
![Screenshot shows Azure portal and workflow integrated chat interface.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/conversational-agent-chat.png)
...
![Screenshot shows Azure portal, workflow designer, and partial autonomous agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/autonomous-agent-workflow-start.png)

The following screenshot shows a new conversational agentic workflow:

![Screenshot shows Azure portal, workflow designer, and partial conversational agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/conversational-agent-workflow-start.png)
...
![Screenshot shows Azure portal, workflow designer, existing workflow, and option to add an agent.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/add-agent.png)
...
![Screenshot shows workflow designer, empty agent action, and agent connection pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/agent-connection-pane.png)
...
![Screenshot shows workflow designer, empty agent action, and agent information pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/agent-information-pane.png)
...
![Screenshot shows workflow designer, empty agent, and selected action to start creating a tool.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/connectors-gallery.png)

The following diagram shows a weather agent that can get the weather forecast and send that forecast in email:

![Screenshot shows Azure portal, workflow designer, and example agent with tools structure.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/agents-workflows-concepts/agent-tools.png)
...
- [Secure agentic workflows with Easy Auth in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/set-up-authentication-agent-workflows)
...
- [Create autonomous agentic workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/create-autonomous-agent-workflows)
- [Create conversational agentic workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/create-conversational-agent-workflows)
