<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/single-versus-multiple-agents -->
...
| Integration capabilities | Easily integrates with external real-world services and services by letting you create agent tools backed by actions from [1,400+ connectors](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors) in Azure Logic Apps. |
| Scalability | Automatically scales with enterprise-grade reliability. |

For more information, see the following articles:

- [AI agent loop orchestration patterns](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/ai-agent-design-patterns)
...
- [Call AI agent loops sequentially to complete subtasks for complex workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/set-up-prompt-chain-agent-workflow)
