<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/set-up-handoff-agent-workflow -->
...
1. On the **Parameters** tab, in the **System instructions** box, provide the following information:
   ...
   ![Screenshot shows finished customer service agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/customer-service-agent.png)
...
1. On the designer, under your customer service agent loop, select the plus (**+**) sign, and then select **Add a hand-off agent**.
   ...
   ![Screenshot shows add handoff button between agent loops and selected option to add a handoff agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/add-handoff-agent.png)
...
1. In the customer service agent loop's **Handoffs** tab, enter the following handoff description:
   ...
   ![Screenshot shows customer service agent loop with handoff to new refund specialist agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/hand-off-to-refund-agent.png)
...
1. On the refund agent loop's **Parameters** tab, in the **System instructions** box, provide the following information:
   ...
   ![Screenshot shows finished refund specialist agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/refund-agent.png)
...
1. In the customer service agent loop's **Handoffs** tab, under the new agent loop, enter the following handoff description:
   ...
   ![Screenshot shows customer service agent with handoff to new sales specialist agent.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/hand-off-to-sales-agent.png)
...
1. On the sales agent loop's **Parameters** tab, in the **System instructions** box, provide the following information:
   ...
   ![Screenshot shows finished sales specialist agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/sales-agent.png)
...
![Screenshot shows completed handoff from the refund agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/hand-off-from-refund-agent.png)
...
![Screenshot shows completed handoff from the sales agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/hand-off-from-sales-agent.png)
...
1. In the **Add an action** pane, find and select the **Compose** action.
   ...
   ![Screenshot shows workflow designer, Compose action pane, and Tool container pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/refund-agent-look-up-tool.png)
...
1. Set up the **Compose** action to implement the tool:
   ...
   1. Select the `<item-ID>` placeholder text. From the available input sources that appear, select the robot icon so you can choose your previously created agent parameter:
      ...
      ![Screenshot shows the Compose action named Find item, the selected item-id placeholder text, and the selected robot icon.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/replace-item-id-placeholder.png)

   1. From the **Agent parameters** list, select **item_id**.

      The **Find item** action inputs look like the following example:

      ![Screenshot shows the Compose action with mock tool call that references the agent parameter.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/replaced-item-id-placeholder.png)

The finished **look_up_item** tool and **Find item** action look like the following example:

![Screenshot shows completed look-up item tool and Find item action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/look-up-tool-complete.png)
...
![Screenshot shows completed process refund tool and Execute refund action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/process-refund-tool-complete.png)
...
![Screenshot shows completed search products tool and Find products action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/search-products-tool-complete.png)
...
![Screenshot shows completed process order tool and Execute order action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/process-order-tool-complete.png)

Your completed handoff agentic workflow looks like the following example:

![Screenshot shows completed handoff agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/handoff-agent-workflow-complete.png)
...
![Screenshot shows the chat history for the test refund scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/test-refund-scenario.png)
...
1. On the **Run history** page, on the **Run history** tab, in the **Identifier** column, select the most recent workflow run.
   ...
   ![Screenshot shows the monitoring view and the agent log pane with chat history, agent loop transitions, and handoff tool calls for the refund scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/agent-log-refund-scenario.png)
...
![Screenshot shows the chat history for the test sales scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/test-sales-scenario.png)
...
1. On the **Run history** page, on the **Run history** tab, in the **Identifier** column, select the most recent workflow run.
   ...
   ![Screenshot shows the monitoring view and the agent log pane with chat history, agent loop transitions, and handoff tool calls for the sales scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-handoff-agent-workflow/agent-log-sales-scenario.png)
...
- [Single agent loops versus multiple agent loops](https://learn.microsoft.com/en-us/azure/logic-apps/single-versus-multiple-agents)
