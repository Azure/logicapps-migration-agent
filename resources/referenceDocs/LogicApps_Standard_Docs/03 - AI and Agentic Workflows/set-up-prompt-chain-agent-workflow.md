<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/set-up-prompt-chain-agent-workflow -->
...
Same requirements as [Create autonomous agentic workflows](https://learn.microsoft.com/en-us/azure/logic-apps/create-autonomous-agent-workflows#prerequisites).
...
1. On the **Parameters** tab, provide the following information:
   ...
   ![Screenshot shows the finished data extraction agent.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-extraction-agent.png)
   ...
   1. From the options that appear when the cursor appears in an edit box, select the dynamic content list (lightning icon).
      ...
      ![Screenshot shows data extraction agent loop, user instructions, example text, and selected lightning icon to open dynamic content list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/open-dynamic-content.png)

   1. From the dynamic content list, under **When an HTTP request is received**, select **report**.

      ![Screenshot shows data extraction agent loop, user instructions, and dynamic content list with selected trigger output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/select-report.png)

      When you're done, the **User instructions** box looks like the following example:

      ![Screenshot shows data extraction agent loop, user instructions, and resolved trigger output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-extraction-user-instructions.png)
...
1. On the **Parameters** tab, provide the following information:
   ...
   ![Screenshot shows the finished data conversion agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-conversion-agent.png)
   ...
   1. From the options that appear when the cursor appears in an edit box, select the expression editor this time (function icon).
      ...
      ![Screenshot shows data extraction agent loop, user instructions, example text, and selected function icon to open expression editor.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/open-expression-editor.png)
   ...
   1. From the dynamic content list, under **Data extraction agent**, select **Last Assistant Message**, and then select **Add**.
      ...
      ![Screenshot shows data conversion agent loop, user instructions, and dynamic content list with selected extraction agent output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/select-last-assistant-message-extraction.png)

      When you're done, the **User instructions** box looks like the following example:

      ![Screenshot shows data conversion agent loop, user instructions, and resolved extraction agent loop output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-conversion-user-instructions.png)
...
1. On the **Parameters** tab, provide the following information:
   ...
   ![Screenshot shows the finished data sorting agent loop.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-sorting-agent.png)
   ...
   1. From the dynamic content list, under **Data conversion agent**, select **Last Assistant Message**, and then select **Add**.
      ...
      ![Screenshot shows data sorting agent loop, user instructions, and dynamic content list with selected conversion agent output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/select-last-assistant-message-conversion.png)

      When you're done, the **User instructions** box looks like the following example:

      ![Screenshot shows data sorting agent loop, user instructions, and resolved conversion agent loop output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/data-sorting-user-instructions.png)
...
1. On the information pane, under **Parameters**, in the **Body** parameter, specify the results to return to the caller.
   ...
   ![Screenshot shows Response action, which returns output from the data sorting agent to the workflow caller.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/set-up-prompt-chain-agent-workflow/response-action.png)
