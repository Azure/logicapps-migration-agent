<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-mcp-server-api-center -->
...
![Diagram shows relationship between MCP server and tools in Azure API Center portal, agent, MCP client, and Azure Logic Apps.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/mcp-server-api-center-portal-architecture.png)
...
- [Built-in service provider-based connectors](https://learn.microsoft.com/en-us/azure/logic-apps/connectors/built-in/reference) and custom connectors currently aren't supported.
...
1. On the **MCP** page, find the **Azure Logic Apps** tile, and select **Register**.
   ...
   ![Screenshot shows Azure portal, selected API Center, and selected Register button on Azure Logic Apps tile.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/register-mcp-server.png)
...
1. On the **Register an MCP server with Azure Logic Apps** wizard home page, follow these steps:
   ...
   1. In the **Project details** section, provide the following information about your MCP server:
      ...
      ![Screenshot shows MCP wizard and Project details section.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/mcp-information.png)

   1. In the **Tools** section, under **Connectors**, select **Add** or **Add new**.

      ![Screenshot shows Connectors section with selected options for Add and Add connector.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/add-connector.png)
   ...
   1. On the **Add connector** pane and the **Choose connector** tab, find and select the connector for which you want to create a tool, for example:
      ...
      ![Screenshot shows Add connector pane with selected Office 365 Outlook connector.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/choose-connector.png)
   ...
   1. On the **Select actions** tab, select each action that you want to create as a tool. When you're done, select **Next**.
      ...
      ![Screenshot shows Add connector pane with selected connector actions to create as tools.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/select-actions.png)
   ...
   1. When you're done, select **Save**, which returns you to the **Register an MCP Server with Azure Logic Apps** page.
      ...
      ![Screenshot shows Connectors and Actions sections with tools list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/tools-list.png)
  ...
  1. To help an agent or LLM choose the correct tool and pass correctly sourced inputs to tool parameters, review and update each tool's setup by following these steps:
     ...
     1. On the **Edit: <*tool-name*>** pane, provide the following information:
        ...
        ![Screenshot shows Edit pane for an example tool.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/tool-parameters.png)
...
1. On the **Settings** toolbar, select **View API Center portal**.
   ...
   **https://\<*API-Center-resource-name*\>.\<*region*\>.azure-apicenter.ms**.
   ...
   For more information, see [Access the API Center portal](https://learn.microsoft.com/en-us/azure/api-center/set-up-api-center-portal.md#access-the-portal).
...
1. In Visual Studio Code, from the **View** menu, select **Command Palette**. Find and select **MCP: Add Server**.
   ...
   ![Screenshot shows Visual Studio Code, Command Palette, and command to add MCP server.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/visual-studio-code-mcp-add-server.png)
...
1. In the **mcp.json** file that opens, select the **Start** or **Restart** link to establish connectivity for your MCP server, for example:
   ...
   ![Screenshot shows mcp.json file with Start link selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/start-server-mcp-json-file.png)
...
1. Sign in and give consent to call your MCP server.
   ...
   ![Screenshot shows mcp.json file with Running status selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-mcp-server-api-center/running-mcp-json-file.png)
