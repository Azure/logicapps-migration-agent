<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-autonomous-agent-workflows -->
...
![Screenshot shows the Azure portal, workflow designer, and example autonomous agentic workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/weather-example.png)

This guide shows how to create a Consumption or Standard logic app that uses the **Autonomous Agents** workflow type. This workflow runs without human interaction and uses tools that you build to complete tasks. For a high-level overview about agentic workflows, see [AI agentic workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/agent-workflows-concepts).
...
- A Consumption logic app resource that uses the workflow type named **Autonomous Agents**. See [Create Consumption logic app workflows in the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-example-consumption-workflow).
...
- A Standard logic app resource or project, based on your development experience:
  ...
  |------------|-------------|
  | Azure portal | A Standard logic app resource. See [Create Standard workflows in the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal). |
  | Visual Studio Code | A Standard logic app project. See [Create Standard workflows in Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-standard-workflows-visual-studio-code). Make sure you have the latest Azure Logic Apps extension. |
...
- One of the following AI model sources:
  ...
  |--------------|-------------|
  | **Azure OpenAI** | An [Azure OpenAI Service resource](https://learn.microsoft.com/en-us/azure/ai-services/openai/overview) with a deployed [Azure OpenAI Service model](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models). <br><br>You need the resource name when you connect from the **Agent** action in your workflow to the deployed AI model in Azure OpenAI Service. <br><br>For more information, see: <br>- [Create and deploy an Azure OpenAI Service resource](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal) <br>- [Deploy a model](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal#deploy-a-model) |
  | **Foundry Agent Service** (Preview) | A [Foundry project](https://learn.microsoft.com/en-us/azure/ai-foundry/what-is-azure-ai-foundry) connected to a deployed [Azure OpenAI model in Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/concepts/models) <br><br>**Note**: Make sure that you have a Foundry project, not a Hub based project. <br><br>For more information, see: <br>- [Create and deploy an Azure OpenAI Service resource](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal) <br>- [Create a project for Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-projects?tabs=ai-foundry) <br>- [Connect Foundry Tools after you create a project](https://learn.microsoft.com/en-us/azure/ai-services/connect-services-ai-foundry-portal#connect-azure-ai-services-after-you-create-a-project) <br>- [Create a new connection in Foundry portal](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add?tabs=aoai%2Cblob%2Cserp&pivots=fdp-project#create-a-new-connection) <br>- [Deploy a model](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal#deploy-a-model) |
  | **APIM Gen AI Gateway** (Preview) | An [Azure API Management account](https://learn.microsoft.com/en-us/azure/api-management/genai-gateway-capabilities) with the LLM API to use. <br><br>For more information, see: <br>- [AI gateway in Azure API Management](https://learn.microsoft.com/en-us/azure/api-management/genai-gateway-capabilities) <br>- [Import a Foundry API](https://learn.microsoft.com/en-us/azure/api-management/azure-ai-foundry-api) <br>- [Import an Azure OpenAI API](https://learn.microsoft.com/en-us/azure/api-management/azure-openai-api-from-specification) |
...
- The authentication to use when you connect the **Agent** action to your AI model.
  ...
  - Managed identity authentication
    ...
    > [!NOTE]
    >
    > If the system-assigned identity is disabled, [reenable the identity](https://learn.microsoft.com/en-us/azure/logic-apps/authenticate-with-managed-identity?tabs=standard#enable-system-assigned-identity-in-the-azure-portal). 
    ...
    - [Authenticate access and connections with managed identities in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/authenticate-with-managed-identity?tabs=standard)
...
[!INCLUDE [supported-models](https://learn.microsoft.com/en-us/azure/logic-apps/includes/supported-models)]

[!INCLUDE [billing-agent-workflows](https://learn.microsoft.com/en-us/azure/logic-apps/includes/billing-agent-workflows)]
...
| Standard | - Unsupported workflow types: **Stateless** <br><br>**Note**: Foundry projects require that you use managed identity authentication. <br><br>- For general limits in Azure OpenAI Service, Foundry, and Azure Logic Apps, see: <br><br>- [Azure OpenAI Service quotas and limits](https://learn.microsoft.com/en-us/azure/ai-services/openai/quotas-limits) <br>- [Azure OpenAI in Foundry Models quotas and limits](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/quotas-limits) <br>- [Azure Logic Apps limits and configuration](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config) |
...
1. On the resource sidebar, under **Development Tools**, select the designer to open the partial agentic workflow.
   ...
   ![Screenshot shows workflow designer with a Request trigger and an empty Default Agent action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/agent-workflow-start-consumption.png)
...
1. On the **Create workflow** pane, complete the following steps:
   ...
   1. Select **Autonomous Agents** > **Create**.
      ...
      ![Screenshot shows Standard logic app with open Workflows page and Create workflow pane with workflow name, selected Autonomous Agents option, and Create button.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/select-autonomous-agents.png)

      The designer opens and shows a partial workflow, which includes an empty **Agent** action that you need to set up later.

      ![Screenshot shows workflow designer with Add a trigger and empty Agent action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/agent-workflow-start-standard.png)
...
1. Add a trigger to your workflow.
   ...
   Your workflow requires a trigger to control when the workflow starts running. You can use any trigger that fits your scenario. For more information, see [Triggers](https://learn.microsoft.com/en-us/azure/connectors/introduction#triggers).

   1. On the designer, select **Add trigger**.

   1. On the **Add a trigger** pane, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action?tabs=standard#add-trigger) to add the best trigger for your scenario.
      ...
      ![Screenshot shows workflow designer with Request trigger and Agent action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/request-trigger.png)
...
1. From the *workflow.json* file's shortcut menu, select **Open designer**.
   ...
   ![Screenshot shows workflow designer with Add trigger prompt and an empty Default Agent action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/workflow-start-standard-visual-studio-code.png)
...
1. Follow the [general steps](add-trigger-action-workflow.md?tabs=standard#add-action) to add an action named **Agent** to your workflow.
   ...
   ![Screenshot shows designer with classic stateful workflow, and option to add an agent.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/add-agent.png)
...
>
> ![Screenshot shows workflow designer toolbar and Errors button with red dot and error in the agent action information pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/error-missing-agent-settings.png)
...
1. On the **Parameters** tab, the **Model Id** parameter shows the Azure OpenAI model that the workflow uses, for example:
   ...
   ![Screenshot shows Consumption workflow and agent loop with Azure OpenAI model.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/connected-model-consumption.png)
...
1. In the **Create a new connection** section, provide the following information:
   ...
   ![Screenshot shows example connection details for a deployed model in Azure OpenAI Service.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/connection-azure-openai.png)
   ...
   ![Screenshot shows example connection details for a deployed model in Foundry.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/connection-ai-foundry.png)

1. When you're done, select **Create new**.

   The **Agent** action information pane now shows the connected AI model, for example:

   ![Screenshot shows example connected AI model.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/connected-model-standard.png)
...
1. On the information pane, select the agent loop name, and enter the new name, such as `Weather agent`.
   ...
   ![Screenshot shows workflow designer, workflow trigger, and renamed agent.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/rename-agent.png)
...
1. In the **Instructions for agent** box, enter the instructions that the agent loop needs to understand its role and tasks.
   ...
   ![Screenshot shows workflow designer and agent loop instructions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/weather-agent-instructions.png)
...
1. On the **Run history** page, in the runs table, select the latest workflow run.
   ...
   ![Screenshot shows monitoring view for Consumption workflow, operation status, and agent log.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/agent-only-test-consumption.png)
...
1. On the **Run history** page, on the **Run history** tab, select the latest workflow run.
   ...
   ![Screenshot shows monitoring view for Standard workflow, operation status, and agent log.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/agent-only-test-standard.png)
...
1. On the **Add an action** pane, follow the [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) for your logic app to add an action that's best for your scenario.
   ...
   ![Screenshot shows workflow designer with the renamed agent loop, which contains a tool that includes the action named Get current weather.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/added-tool-get-current-weather.png)
...
1. On the **Details** tab, for **Description**, enter the tool description. For this example, use `Get the weather for the specified location.`
   ...
   ![Screenshot shows completed Get weather tool with description.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/get-weather-tool.png)
...
1. On the right edge of the **Location** box, select the stars button.
   ...
   ![Screenshot shows an action with the mouse cursor inside a parameter box, parameter options, and the selected option to generate an agent parameter.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/generate-agent-parameter.png)
   ...
   > [!NOTE]
   >
   > Microsoft recommends that you follow the action's Swagger definition. For example, for the **Get current weather** action, which comes from the **MSN Weather** "shared" connector hosted and managed by global, multitenant Azure, see the [**MSN Weather** connector technical reference article](https://learn.microsoft.com/en-us/connectors/msnweather/#get-current-weather).

1. When you're ready, select **Create**.

   The following example shows the **Get current weather** action with the **Location** agent parameter:

   ![Screenshot shows the Weather agent, Get weather tool, and selected action named Get current weather. The Location action parameter includes the created agent parameter.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/get-current-weather-action.png)
...
For more information, see [Reference guide to workflow expression functions in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/workflow-definition-language-functions-reference).
...
1. Expand **New agent parameter**, and provide the following information, but match the action parameter details.
   ...
   > [!NOTE]
   >
   > Microsoft recommends that you follow the action's Swagger definition. For example, to find this information for the **Get current weather** action, see the [**MSN Weather** connector technical reference article](https://learn.microsoft.com/en-us/connectors/msnweather/#get-current-weather). The example action is provided by the **MSN Weather** managed "shared" connector, which is hosted and run in global, multitenant Azure.
...
1. From the **Agent parameters** list, select the agent parameter that you defined earlier.
   ...
   ![Screenshot shows agent and finished Get weather tool.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/get-weather-tool-complete.png)
...
1. On the **Add an action** pane, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) to select another action for your new tool.
   ...
   ![Screenshot shows workflow designer with Weather agent, Get weather tool, and new tool with action named Send an email (V2).](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/added-tool-send-email.png)
...
1. On the **Details** tab, for **Description**, enter the tool description. For this example, use `Send current weather by email.`
   ...
   ![Screenshot shows completed Send email tool with description.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/send-email-tool.png)
...
1. Follow the earlier general steps to create agent parameters for the parameter values in the **Send an email (V2)** action.
   ...
   The action needs three agent parameters named **To**, **Subject**, and **Body**. For the action's Swagger definition, see [**Send an email (V2)**](https://learn.microsoft.com/en-us/connectors/outlook/#send-an-email-(v2)).

   When you're done, the example action uses the previously defined agent parameters as shown in the following image:

   ![Screenshot shows the information pane for the action named Send an email V2, plus the previously defined agent parameters named To, Subject, and Body.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/send-email-action.png)

   The finished **Send email** tool looks like the following example:

   ![Screenshot shows the agent and finished Send email tool.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/send-email-tool-complete.png)
...
1. Rename the **Compose** action to `Subscriber list`. In the **Input** box, use the following JSON array but replace the sample subscriber data with the data that you want to use for testing. For example, replace the email addresses with your own so you get the weather for different locations.
   ...
   ![Screenshot shows the agent action and finished Get subscribers tool.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-autonomous-agent-workflows/get-subscribers-tool-complete.png)
...
[!INCLUDE [best-practices-agent-workflows](https://learn.microsoft.com/en-us/azure/logic-apps/includes/best-practices-agent-workflows)]

[!INCLUDE [troubleshoot-agent-workflows](https://learn.microsoft.com/en-us/azure/logic-apps/includes/troubleshoot-agent-workflows)]

[!INCLUDE [clean-up-resources](https://learn.microsoft.com/en-us/azure/logic-apps/includes/clean-up-resources)]

## Related content

- [AI agentic workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/agent-workflows-concepts)
