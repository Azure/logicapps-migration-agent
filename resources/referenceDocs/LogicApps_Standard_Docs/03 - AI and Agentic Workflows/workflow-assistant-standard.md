<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/workflow-assistant-standard -->
...
![Screenshot shows Azure portal, Standard logic app with workflow designer opened, and workflow assistant with example question and generated response.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/overview.png)
...
> and follows responsible and ethical AI practices in accordance with the [Microsoft responsible AI principles and approach](https://www.microsoft.com/ai/principles-and-approach). For more information, see [Azure customer data protection](https://learn.microsoft.com/en-us/azure/security/fundamentals/protection-customer-data) and [Microsoft data protection and privacy](https://www.microsoft.com/trust-center/privacy). 

## Prerequisites

- An Azure account and subscription. If you don't have a subscription, [sign up for a free Azure account](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).

- A [Standard logic app workflow](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal).
...
1. On the workflow designer toolbar, select **AI** > **Assistant**.
   ...
   ![Screenshot shows Azure portal, Standard logic app with workflow designer opened, and workflow toolbar with Assistant selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/open-workflow-assistant.png)

   The **Workflow assistant** pane opens:

   ![Screenshot shows Azure portal, Standard workflow designer, and open workflow assistant pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/chat-open-first-time.png)
...
1. In the chat box, enter your question about the current workflow or about Azure Logic Apps.
   ...
   ![Screenshot shows Azure portal, Standard workflow designer, open workflow assistant pane, and chat box with a question entered.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/ask-question.png)

   The workflow assistant researches your question and generates an answer, for example:

   ![Screenshot shows open workflow assistant pane, and chat box with a generated answer to the previously entered question.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/question-response.png)
...
1. Select the thumbs-down icon:
   ...
   ![Screenshot shows workflow assistant pane feedback options with down-vote icon selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/workflow-assistant-standard/thumbs-down.png)
...
**A**: The workflow assistant follows responsible practices in accordance with the [Azure Privacy policy](https://azure.microsoft.com/explore/trusted-cloud/privacy). For more information, see [Azure customer data protection](https://learn.microsoft.com/en-us/azure/security/fundamentals/protection-customer-data) and [Microsoft data protection and privacy](https://www.microsoft.com/trust-center/privacy).
...
**A**: [Azure OpenAI Service](https://learn.microsoft.com/en-us/azure/ai-services/openai/overview) is an enterprise-ready AI technology. This service is optimized for your business processes and your business data to meet security and privacy requirements.
