<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-parameters-workflows -->
...
For more information about multitenant and single-tenant Azure Logic Apps, see [Single-tenant versus multitenant in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/single-tenant-overview-compare).
...
- A Consumption or Standard logic app workflow
  ...
  If you don't have a logic app workflow yet, see [Create a Consumption logic app workflow](https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-create-example-consumption-workflow) or [Create a Standard logic app workflow](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal).
...
1. On the designer toolbar, select **Parameters**.
   ...
   ![Screenshot shows the Azure portal with the workflow designer open and Parameters on designer toolbar highlighted.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-parameters-workflows/select-parameter.png)
...
1. Provide the following information about the parameter to create:
   ...
   ![Screenshot shows the Azure portal with the workflow designer and the Parameters pane with an example parameter definition.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-parameters-workflows/define-parameter.png)
...
1. From that list, under **Parameters**, select your previously created parameter.
   ...
   ![Screenshot shows created parameter in the dynamic content list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-parameters-workflows/reference-parameter.png)
...
>
> For more information, see [Considerations for using functions](https://learn.microsoft.com/en-us/azure/logic-apps/workflow-definition-language-functions-reference#function-considerations).
...
To review and define your app settings in an ARM template or Bicep file, find your logic app's resource definition, and update the `appSettings` JSON object. For the full resource definition, see the [ARM template reference](https://learn.microsoft.com/en-us/azure/templates/microsoft.web/sites).
