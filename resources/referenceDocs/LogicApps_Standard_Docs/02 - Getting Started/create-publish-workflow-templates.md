<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-publish-workflow-templates -->
...
![Screenshot shows Azure portal and workflow templates gallery with Azure subscription-scoped custom templates in testing and production.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/templates-labels.png)
...
- Screenshots that show read-only preview images for the workflow that the template creates. Use the **.png** file name extension for these screenshots. These preview images for template appear on the template overview pane in the templates gallery.
  ...
  To store these images so that your template can use them, you need an [Azure storage account](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-create.md?toc=%2Fazure%2Fstorage%2Fblobs%2Ftoc.json&tabs=azure-portal) and a [blob container](https://learn.microsoft.com/en-us/azure/storage/blobs/blob-containers-portal.md#create-a-container).
...
1. On the **Summary** tab or a preceding tab, at the tab bottom, from the **Save** list, select **Save + publish for testing**.
   ...
   ![Screenshot shows Azure portal, Profile tab, and option selected for Save + publish for testing.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/publish-testing.png)

   Azure publishes the template, which displays the **Testing** label, to the templates gallery.

1. To test your new template, follow the steps in [Create workflows from prebuilt templates](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflows-from-templates) but with these steps:
   ...
   1. From the **Status** list, select **Published for Testing**. Under the filters row, select **My Templates**.
      ...
      ![Screenshot shows Azure portal, templates gallery, and selected tab for My templates.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/my-templates.png)
...
1. From the **Save** list, select **Save + publish for production**.
   ...
   ![Screenshot shows Azure portal, Profile tab, and option selected for Save + publish for production.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/publish-production.png)
...
1. From the **Save** list, select **Save + unpublish template**.
   ...
   ![Screenshot shows Azure portal, Profile tab, and option selected for Save + unpublish template.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/remove-template.png)
...
1. From the code view window, copy the entire workflow definition, for example:
   ...
   ![Screenshot shows Azure portal, code view window, and Request-Response workflow definition.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/standard-workflow-code-view.png)
...
1. In GitHub, create a pull request to compare **<*your-working-branch*>** with the **main** branch in the **LogicAppsTemplates** repository.
   ...
   1. Make sure that your pull request has the following settings, and then select **Create pull request**.
      ...
      ![Screenshot shows GitHub and pull request settings.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-publish-workflow-templates/github-pull-request.png)
...
[Create logic app workflows from prebuilt templates](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflows-from-templates)
