<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/estimate-storage-costs -->
...
* A single-tenant based logic Apps workflow. You can create a workflow [using the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal) or [using Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code). If you don't have a workflow yet, you can use the sample small, medium, and large workflows in the storage calculator.

* An Azure storage account that you want to use with your workflow. If you don't have a storage account, [create a storage account](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-create)
...
1. Go to the [Logic Apps storage calculator](https://logicapps.azure.com/calculator).
   ...
   ![Screenshot of Logic Apps storage calculator, showing input interface.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/estimate-storage-costs/storage-calculator.png)
...
1. Under **Storage Operation Breakdown and Calculation Steps**, review the **Operation Counts** estimates.
    ...
    * **Tables**, for Azure Table Storage operations.
    ...
    ![Screenshot of Logic Apps storage calculator, showing output with estimated operations.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/estimate-storage-costs/storage-calculator-results.png)
...
1. On the **Products** tab, select **Storage** &gt; **Storage Accounts**. Or, in the **Search Bar** search box, enter **Storage Accounts** and select the tile.
   ...
   ![Screenshot of Azure pricing calculator, showing tile to add Storage Accounts view.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/estimate-storage-costs/pricing-calculator-storage-tile.png)
...
> [Plan and manage costs for Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/plan-manage-costs)