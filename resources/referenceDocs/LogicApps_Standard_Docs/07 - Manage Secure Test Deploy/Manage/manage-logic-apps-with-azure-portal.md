<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal -->
...
1. On the **Workflows** page toolbar, select **Add** > **Add**.
   ...
   ![Screenshot shows selected logic app Workflows page and toolbar with Add command selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-with-azure-portal/add-new-workflow.png)
...
1. [Restart your logic app](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=consumption#disable-enable-logic-apps).
...
1. [Restart your logic app](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#disable-enable-logic-apps).
...
* If you delete a logic app and workflow, but you then recreate the same logic app and workflow, the recreated workflow doesn't have the same metadata as the deleted workflow.
  ...
  [!INCLUDE [refresh-metadata-caller-workflow](https://learn.microsoft.com/en-us/azure/logic-apps/includes/refresh-metadata-caller-workflow)]
...
| **App Service Environment V3** | Before you delete your app, download the Standard logic app from the Azure portal. For more information, see [Download Standard logic app artifacts from portal](https://learn.microsoft.com/en-us/azure/logic-apps/set-up-devops-deployment-single-tenant-azure-logic-apps?tabs=github#download-standard-logic-app-artifacts-from-portal). | Redeploy your logic app. |
...
1. In the [Azure portal](https://portal.azure.com), confirm that the storage account used by your logic app still exists. If the storage account is deleted, you have to [first recover the deleted storage account](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-recover).

   1. To identify the storage account name, open your logic app.

   1. On the logic app menu, under **Settings**, select **Environment variables**.

   1. On the **Environment variables** page, under **App settings**, find the app setting named [**AzureWebJobsStorage**](https://learn.microsoft.com/en-us/azure/logic-apps/edit-app-settings-host-settings?tabs=azure-portal#reference-for-app-settings---localsettingsjson).
...
> such as [Azure Key Vault](https://learn.microsoft.com/en-us/azure/key-vault/general/overview), which you can use with 
> [app settings](https://learn.microsoft.com/en-us/azure/logic-apps/edit-app-settings-host-settings?tabs=azure-portal#reference-for-app-settings---localsettingsjson) in your Standard logic app resource. 
> You can then [directly reference these secure strings](https://learn.microsoft.com/en-us/azure/app-service/app-service-key-vault-references). 
>
> Similar to ARM templates, where you can define environment variables at deployment time, you can define app 
> settings in your [logic app workflow definition](https://learn.microsoft.com/en-us/azure/templates/microsoft.logic/workflows). You can then 
...
1. On the logic app menu, under **Development Tools**, select **Versions**.
   ...
   ![Screenshot shows Azure portal, Consumption logic app menu with Versions selected, and previous logic app versions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-with-azure-portal/logic-apps-menu-versions.png)
...
1. From the **Version** list, select the workflow version that you want.
   ...
   ![Screenshot shows history version page with designer view and code view options.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-with-azure-portal/history-version.png)
...
1. On the **History version** toolbar, select **Promote**.
   ...
   ![Screenshot shows History version page toolbar with selected Promote button.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-with-azure-portal/promote-button.png)
