<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-visual-studio-code -->
...
1. In Visual Studio Code, on the Activity Bar, select the Azure icon to open the **Azure** pane.
   ...
   ![Screenshot shows the Visual Studio Code Activity Bar and selected Azure icon.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-visual-studio-code/visual-studio-code-azure-icon.png)
...
1. In Visual Studio Code, on the Activity Bar, select the Azure icon to open the **Azure** pane.
   ...
   ![Screenshot shows Visual Studio Code Activity Bar and selected Azure icon.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-visual-studio-code/visual-studio-code-azure-icon.png)
...
1. In the **Logic Apps (Consumption)** section, expand your Azure subscription.
   ...
   ![Screenshot shows Visual Studio Code with Resources section and deployed Consumption logic app resource.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-visual-studio-code/find-deployed-logic-app-consumption.png)
...
1. In the **Resources** section, expand your subscription, and then expand **Logic App**.
   ...
   ![Screenshot shows Visual Studio Code with Resources section and deployed Standard logic app resource.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/manage-logic-apps-visual-studio-code/find-deployed-logic-app-standard.png)
...
>
> - [Considerations for stopping Consumption logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=consumption#considerations-stop-consumption-logic-apps)
> - [Considerations for stopping Standard logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#considerations-stop-standard-logic-apps)
...
1. When you're done, [publish your updated Standard logic app](https://learn.microsoft.com/en-us/azure/logic-apps/create-standard-workflows-visual-studio-code#publish-new-logic-app).
...
- [Considerations for stopping Consumption logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=consumption#considerations-stop-consumption-logic-apps)
- [Considerations for stopping Standard logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#considerations-stop-standard-logic-apps)
- [Considerations for disabling Standard workflows](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#considerations-disable-enable-standard-workflows)
...
In Visual Studio Code, you can stop, start, or restart a Standard logic app, which affects all workflow instances. You can also restart a Standard logic app without first stopping its activity. However, to disable and reenable individual workflows, [you must use the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal#stop-start-standard-workflows).
...
- [Considerations for deleting Consumption logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=consumption#considerations-delete-consumption-logic-apps)
- [Considerations for deleting Standard logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#considerations-delete-standard-logic-apps)
- [Considerations for deleting Standard workflows](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#considerations-delete-standard-workflows)
...
In Visual Studio Code, you can only delete an entire Standard logic app. To delete individual workflows, [use the Azure portal](https://learn.microsoft.com/en-us/azure/logic-apps/manage-logic-apps-with-azure-portal?tabs=standard#delete-standard-workflows).
...
- [Create Standard logic app workflows in Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-standard-workflows-visual-studio-code)
