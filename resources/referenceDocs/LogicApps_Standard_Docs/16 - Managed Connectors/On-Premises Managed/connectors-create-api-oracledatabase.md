<!-- Source: https://learn.microsoft.com/en-us/azure/connectors/connectors-create-api-oracledatabase -->
...
* The logic app workflow where you want to connect to your Oracle database. This connector provides only actions, not triggers. You can use any trigger that you want to start your workflow. To create the logic app and add a trigger, see the following documentation:
  ...
  * [Add a trigger to your workflow](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action.md#add-trigger)
...
For more information, see the [connector's reference documentation](https://learn.microsoft.com/en-us/connectors/oracle/).

## Connector technical reference

For available connector operations, see the [connector's reference documentation](https://learn.microsoft.com/en-us/connectors/oracle/).

## Add an action

1. [Follow these generic steps to add the **Oracle Database** action that you want](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action).
