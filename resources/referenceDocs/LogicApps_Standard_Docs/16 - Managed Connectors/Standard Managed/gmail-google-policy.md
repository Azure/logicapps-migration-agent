<!-- Source: https://learn.microsoft.com/en-us/azure/connectors/connectors-google-data-security-privacy-policy -->
...
Starting **May 1, 2020**, changes due to Google's [data security and privacy policies](https://www.blog.google/technology/safety-security/project-strobe/) might affect logic app workflows that use the Google connectors, such as the [Gmail connector](https://learn.microsoft.com/en-us/connectors/gmail/).
...
- This logic app workflow uses the Gmail connector with the HTTP built-in trigger:
  ...
  ![Screenshot shows a noncompliant workflow that uses a Google email action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/noncompliant-gmail-connector.png)
...
- This workflow uses the Gmail connector with the Azure Blob Storage connector:
  ...
  ![Screenshot shows a noncompliant workflow that uses a Google action with a create blob action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/noncompliant-blob-storage.png)

- This workflow uses the Gmail connector with the X connector:

  ![Screenshot shows a noncompliant workflow that uses an X action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/noncompliant-create-tweet.png)

For the most recent information, see the [Gmail connector's technical reference documentation](https://learn.microsoft.com/en-us/connectors/gmail/).
...
For more information, see the [Gmail connector's technical reference documentation](https://learn.microsoft.com/en-us/connectors/gmail/#authentication-and-bring-your-own-application).

### Create Google client app

To set up a project for your client app, use the [Google API Console wizard](https://console.developers.google.com/start/api?id=gmail&credential=client_key) and follow the instructions. Or, see the [Gmail connector's technical reference documentation](https://learn.microsoft.com/en-us/connectors/gmail/#authentication-and-bring-your-own-application).
...
![Screenshot shows the Google API's partner site with client ID and client secret for your Google client app.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/google-api-console.png)
...
1. In **Change connection**, select **Add new**:
   ...
   ![Screenshot shows the Change connection page where you can add a new connection.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/change-gmail-connection.png)

1. Enter a name for the connection and then provide your connection information: 

   ![Screenshot shows the Create connection page.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/authentication-type-bring-your-own.png)
...
1. When you're done, select **Sign in**.
   ...
   ![Screenshot shows the prompt for access to your Google account.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-google-data-security-privacy-policy/allow-access-authorized-domain.png)
...
- Learn more about the [Gmail connector](https://learn.microsoft.com/en-us/connectors/gmail/)
