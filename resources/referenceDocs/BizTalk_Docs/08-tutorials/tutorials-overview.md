> **Source:** https://learn.microsoft.com/en-us/biztalk/core/biztalk-server-tutorials

# BizTalk Server Tutorials

Tutorials to learn how to use BizTalk Server.

The BizTalk Server tutorials contain simple scenarios to give new users an experience of using a variety of BizTalk tools while creating compiled, testable integration solutions. For more advanced users, or users who are designing BizTalk solutions, see [Scenarios for Business Solutions](https://learn.microsoft.com/en-us/biztalk/core/scenarios-for-business-solutions).

## Enterprise Application Integration

[Tutorial: Enterprise Application Integration](https://learn.microsoft.com/en-us/biztalk/core/tutorial-1-enterprise-application-integration)
...
[Tutorial: Creating a Hybrid Application Using BizTalk Server](https://learn.microsoft.com/en-us/biztalk/core/tutorial-4-creating-a-hybrid-application-using-biztalk-server-2013)
...
[Tutorial: Invoking a REST Interface Using BizTalk Server](https://learn.microsoft.com/en-us/biztalk/core/tutorial-5-invoking-a-rest-interface-using-biztalk-server)

Uses the WCF-WebHttp adapter to use a REST URL, and then send a response message.

## Integrate BizTalk with Salesforce

[Tutorial: Integrating BizTalk Server with Salesforce](https://learn.microsoft.com/en-us/biztalk/core/tutorial-integrating-biztalk-server-2013-with-salesforce)
...
[Processing JSON messages using BizTalk Server](https://learn.microsoft.com/en-us/biztalk/core/processing-json-messages-using-biztalk-server)
...
[Tutorial: EDI Interface Developer Tutorial](https://learn.microsoft.com/en-us/biztalk/core/tutorial-2-edi-interface-developer-tutorial)
...
[Tutorial: AS2 Tutorial](https://learn.microsoft.com/en-us/biztalk/core/tutorial-3-as2-tutorial)
...
- [Get started](https://learn.microsoft.com/en-us/biztalk/core/getting-started-with-biztalk-server)
- [Plan and architect your BizTalk Server solution](https://learn.microsoft.com/en-us/biztalk/core/plan-and-architect-your-biztalk-server-solution)
