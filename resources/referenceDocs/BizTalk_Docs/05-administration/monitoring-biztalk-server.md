> Source: https://learn.microsoft.com/en-us/biztalk/core/monitoring-biztalk-server
...
| Tool | Task |
|------|------|
| BizTalk Health Monitor tool (BHM) | An MMC snap-in for users to monitor the health of BizTalk Server environments, detect critical and non-critical issues, and execute maintenance tasks. [Download BizTalk Health Monitor](https://learn.microsoft.com/en-us/biztalk/core/monitoring-biztalk-server). BizTalk Health Monitor also includes the latest versions of MsgBox Viewer and BizTalk Terminator. |
...
The Monitor BizTalk Server job is configured and automated to run once a week. Since the job is computationally intensive, it is recommended to schedule it during downtime/low traffic.

The job fails if it encounters any issues; error string contains the number of issues found. Otherwise, it runs successfully. You can see the details in the job history. If you run the job with Administrator privileges, the error string will be logged to Event Viewer also (along with the job history).
...
- [Using the BizTalk Server Administration Console](https://learn.microsoft.com/en-us/biztalk/core/using-the-biztalk-server-administration-console)
- [Viewing Tracked Message and Instance Data](https://learn.microsoft.com/en-us/biztalk/core/viewing-tracked-message-and-instance-data)
- [Monitoring EDI and AS2 Solutions](https://learn.microsoft.com/en-us/biztalk/core/monitoring-edi-and-as2-solutions)
- [Tracking Dependencies Between Artifacts in a BizTalk Server Application](https://learn.microsoft.com/en-us/biztalk/core/tracking-dependencies-between-artifacts-in-a-biztalk-server-application)
- [Performance Counters](https://learn.microsoft.com/en-us/biztalk/core/performance-counters)
