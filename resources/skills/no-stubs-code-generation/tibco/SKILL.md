...
2. Read decompiled code from `out/__decompiled__/` in the current migration workspace directory if original Java source is unavailable.
...
5. For Mapper/XSLT scripts, convert the full transformation logic — do NOT leave partial conversions.
